...
{    
    ...
    public partial class Form1 : Form
    {
        ...
        private delegate void DAddItem(String Cristal); 
        
   
              
        
        private void AddItem(String Cristal)
        {
            listBox1.Items.Add(Cristal);
        }
         ...
         void Conectar()
        {
            try
            {
                client.Connect("192.168.119.1", 8000);
                if (client.Connected)
                {
                    Thread f = new Thread(Listen);
